...
class Project_task_model extends CI_Model {
    ...
    function info($param)
    {
        ...
        $this->db->select('id_project_task, id_project, id_user, name, status, group_task,
						  start_date, end_date, finished_date, created_date, updated_date');
    ...
    function lists($param)
    {
        ...
        $this->db->select('id_project_task, id_project, '.$this->table.'.id_user,
						  '.$this->table.'.name, '.$this->table.'.status, group_task, start_date,
						  end_date, finished_date, '.$this->table.'.created_date,
