...
<script src="<?php echo base_url('assets/js/noty/packaged').'/jquery.noty.packaged.min.js'; ?>" type="text/javascript"></script>
...
<!--<script src="<?php echo base_url('assets/js/theme/datepicker').'/moment.min.js'; ?>" type="text/javascript"></script>-->
<!--<script src="<?php echo base_url('assets/js/theme/datepicker').'/daterangepicker.min.js'; ?>" type="text/javascript"></script>-->
<script src="<?php echo base_url('assets/js/theme/datepicker').'/bootstrap-datepicker.min.js'; ?>" type="text/javascript"></script>
<script src="<?php echo base_url('assets/js/theme').'/app.min.js'; ?>" type="text/javascript"></script>
<script src="<?php echo base_url('assets/js/theme/datepicker').'/components-date-time-pickers.min.js'; ?>" type="text/javascript"></script>
